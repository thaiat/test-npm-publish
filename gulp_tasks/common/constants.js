...
var getRepository = function() {
    var repository = 'https://github.com/thaiat/test-npm-publish';
    try {
...
module.exports = function() {
    ...
    var constants = {
        ...
        lint: [
            ...
            './server/**/*.js', 'gulpfile.js', './gulp_tasks/**/*.js', 'karma.conf.js', 'webpack.config.js', 'protractor.conf.js', './test/**/*.js', 'index.js'
        ],
        fonts: {
        ...
        serve: {
            ...
            localtunnel: false, // true, false or 'test-npm-publish'
            ghostMode: {
                clicks: false,
                forms: false,
                scroll: false
